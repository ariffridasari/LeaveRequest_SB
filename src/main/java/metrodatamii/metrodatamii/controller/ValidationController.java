...
public class ValidationController {
    ...
    public String templateEmail(String name, String token) {
        ...
        String template = "<div style=\"background:#fff; border:2px solid #cccccc; padding:40px\">\n"
                ...
                + "<p>Hai " + name +",</p>\n"
                + "<p>Kami menerima permintaan untuk mengatur ulang kata sandi Leave Request anda.</p>\n"
                ...
                + "<center><a href=\"" + link + "\" target=\"_blank\"><h1 style=\"background:linear-gradient(#373B44, #4286f4); border-radius:5px; color:#ffffff; display:inline-block; padding:8px 20px\"><strong>Ubah Kata Sandi</strong></h1></a></center>\n"
                ...
                + "<p>&nbsp;</p>\n"
                + "<p>Support by :&nbsp;</p>\n"
                + "<p>Arif Fridasari & Sekar Savitri</p>"
                + "</div>";
        return template;
    }
}
